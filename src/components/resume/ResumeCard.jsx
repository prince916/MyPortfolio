    ...
    <div className='w-full h-1/3 group flex'>
      ...
      <div className='w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-0
        ...
        <div className='flex justify-between items-center'>
          ...
          <div>
            <p className='w-20 h-10 text-designColor bg-bodyColor bg-opacity-25 rounded-lg 
            flex justify-center items-center shadow-shadowOne text-sm font-medium'>{result}</p>
          </div>
        </div>
        <p className='text-sm mt-2 text-gray-400 group-hover:text-white duration-300'>{des}</p>
      </div>
    </div>
  )
}
